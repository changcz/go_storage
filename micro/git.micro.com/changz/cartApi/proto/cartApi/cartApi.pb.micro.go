...
type CartApiService interface {
	FindAll(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error)
}
...
func (c *cartApiService) FindAll(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
type CartApiHandler interface {
	FindAll(context.Context, *proto1.Request, *proto1.Response) error
}

func RegisterCartApiHandler(s server.Server, hdlr CartApiHandler, opts ...server.HandlerOption) error {
	type cartApi interface {
		FindAll(ctx context.Context, in *proto1.Request, out *proto1.Response) error
	}
	type CartApi struct {
		cartApi
	}
...
func (h *cartApiHandler) FindAll(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
